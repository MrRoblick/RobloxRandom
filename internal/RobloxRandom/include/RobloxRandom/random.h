...
namespace RobloxRandom {
    ...
    public:
        ...
        Structures::Vector3 next_unit_vector();
        ...
        static std::optional<uint64_t> find_seed_from_sequence(const std::vector<Structures::TargetInfo>& targets);
#endif
    };
}
